...
TEST_CASE("USEEDLinkToDataPacketImportProxy::StreamSelector",
          "[streamSelector]")
{
    namespace USD = USEEDLinkToDataPacketImportProxy;
    ...
    {
        auto streamSelector
           = USD::StreamSelector::fromString(" UU eLu  eH? 20  ");
        REQUIRE(streamSelector.getNetwork() == "UU");
    ...
    {   
        auto streamSelector
           = USD::StreamSelector::fromString(" UU bhu  hH?  d ");
        REQUIRE(streamSelector.getNetwork() == "UU");
        REQUIRE(streamSelector.getStation() == "BHU");
          ...
          "[clienOptions]")
{
    ...
    SECTION("Options")
    {
        ...
        std::vector<USD::StreamSelector> selectors;

        USD::StreamSelector selector1;
        ...
        selector2.setSelector(channel2, "01", USD::StreamSelector::Type::Data);
